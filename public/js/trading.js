var app = angular.module('tradingApp',['ngRoute']).config(['$httpProvider', function($httpProvider) {
...
var round_time = timing_closeing_set;
        ...
        var selectiing_value;
        if (document.getElementById('option2').checked) {
            selectiing_value = document.getElementById('option2').value;
          }
        if (document.getElementById('option3').checked) {
            selectiing_value = document.getElementById('option3').value;
          }
          if($scope.amount == '' || $scope.amount == undefined || $scope.amount == null ){
            $("#hefly").notify("Please enter the Amount");
            return false;
  }else{}
    if(selectiing_value == '' || selectiing_value == undefined || selectiing_value == null ){
                  $("#setting_up").notify("Please select the high or low option");
                  return false;
        }else{}
        var price_val_bid= hefflybidvalue();
        var object = {
          "user_bid" : price_val_bid,
          "amount" : amount,
          "high_or_low" : selectiing_value,
          "auto_close_time" : round_time
...
//get time
function timing() {
   var timming_bro =  moment().format("h:mm:ss");  
    return timming_bro;
}
...
function hefflybidvalue() {
  return price_val_bid;
}
